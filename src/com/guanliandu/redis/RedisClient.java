...
public class RedisClient {
	...
	private void initialPool() {
		// 池基本配置
		//pool2中修改如下：maxActive  ==>  maxTotal   maxWait ==> maxWaitMillis
		...
		//192.168.1.187
		jedisPool = new JedisPool(config, "192.168.31.170", 6379);
	...
	private void initialShardedPool() {
		...
		JedisShardInfo shardInfo = new JedisShardInfo("192.168.31.170", 6379);
	    shardInfo.setPassword("finedo-redis");
